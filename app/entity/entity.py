...
class Shortlist(db.Model):
    ...
    @classmethod
    def create_shortlist(cls, user_id, listing_id):
    ...
    @classmethod
    def delete_shortlist(cls, user_id, listing_id):
...
class Review(db.Model):
    ...
    @classmethod
    def create_review(cls, agent_id, user_id):
        
        new_review = cls(agent_id=agent_id, user_id=user_id)
        db.session.add(new_review)
        db.session.commit()
        return new_review
    
    @classmethod
    def get_review(cls, agent_id, user_id):
...
class Rating(db.Model):
    ...
    @classmethod
    def create_or_update_rating(cls, rating_value, review_id):
        ...
        if rating:
            ...
            new_rating = cls(review_id=review_id, rating=rating_value)
...
class Comment(db.Model):
    ...
    @classmethod
    def create_or_update_comment(cls, comment_value, review_id):
        ...
        if comment:
            ...
            new_comment = cls(comment=comment_value, review_id=review_id)
