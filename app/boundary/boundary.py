...
# class generateListing(MethodView): 
#     def get(self):
#         status_messages = []
...
#                 'type': 'Apartment',
#                 'price': str(random.randint(500000, 3000000)),
#                 'bedrooms': str(random.randint(1, 6)),
#                 'bathrooms': str(random.randint(1, 3)),
#                 'size_sqft': str(random.randint(1000, 2000)),
#                 'location': random.choice(locations),
#                 'file_path': f'./media/apartment{i}.jpg',
#                 'user_email': f'seller{i}@example.com',
#                 'agent_id': f'{i}'
#             }
#             result = createListingController().get(**data)
#             status_messages.append(f'Listing {i} created successfully.' if result else f'Failed to create listing {i}.')
        
#         return render_template("agent/generate.html", status_messages=status_messages)
                
# boundary.add_url_rule("/generate", view_func=generateListing.as_view("generateListing"))

# class generateRating(MethodView):
#     def get(self):
#         status_messages = []
#         possible_value = [0.5 * i for i in range(0, 11)]
#         for i in range (2, 102):
#             data = {
#                 'rating_value': str(random.choice(possible_value)),
#                 'user_id': f'{i}',
#                 'agent_id': str(random.randint(1, 100))
#             }
#             result = createRatingController().get(**data)
#             status_messages.append(f'Rating {i} created successfully.' if result else f'Failed to create rating {i}.')

#         return render_template("generate.html", status_messages=status_messages)
    
# boundary.add_url_rule("/generate", view_func=generateRating.as_view("generateRating"))

# class generateReview(MethodView):
#     def get(self):
#         status_messages = []
#         for i in range (2, 102):
#             data = {
#                 'review_value': f'Review {i}',
#                 'user_id': f'{i}',
#                 'agent_id': str(random.randint(1, 100))
#             }
#             result = createReviewController().get(**data)
#             status_messages.append(f'Review {i} created successfully.' if result else f'Failed to create review {i}.')

#         return render_template("generate.html", status_messages=status_messages)
    
# boundary.add_url_rule("/generate", view_func=generateReview.as_view("generateReview"))
...
#             data = {
#                 'date_created': datetime.strptime('2024-05-20 00:00:00', '%Y-%m-%d %H:%M:%S'),
#                 'user_id': f'{i}',
#                 'listing_id': str(random.randint(1, 100))
#             }
#             result = createViewCountController().get(**data)
#             status_messages.append(f'View {i} created successfully.' if result else f'Failed to create View {i}.')

#         return render_template("generate.html", status_messages=status_messages)

# boundary.add_url_rule("/generate", view_func=generateView.as_view("generateView"))

# class generateShortlist(MethodView):
#     def get(self):
#         status_messages = []
#         for i in range (2, 102):
#             data = {
...
#                 'listing_id': str(random.randint(1, 100))
#             }
#             result = createShortlistController().get(**data)
#             status_messages.append(f'Shortlist {i} created successfully.' if result else f'Failed to create Shortlist {i}.')

#         return render_template("generate.html", status_messages=status_messages)

# boundary.add_url_rule("/generate", view_func=generateShortlist.as_view("generateShortlist"))