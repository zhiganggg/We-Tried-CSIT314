...
#views
controller.add_url_rule("/login", view_func=loginController.as_view("login"))
...
#views
controller.add_url_rule("/logout", view_func=logoutController.as_view("logout"))
...
#views
controller.add_url_rule("/sign-up", view_func=signupController.as_view("signup"))
...
#views
controller.add_url_rule("/update-account", view_func=updateAccountController.as_view("updateAccount"))
...
#views
controller.add_url_rule("/update-password", view_func=updatePasswordController.as_view("updatePassword"))
...
#views
controller.add_url_rule("/home", view_func=homeController.as_view("home"))
...
#views
controller.add_url_rule("/profile", view_func=profileController.as_view("profile"))
...
#views
controller.add_url_rule("/create-profile", view_func=createProfleController.as_view("createProfile"))
...
#views
controller.add_url_rule("/update-profile", view_func=updateProfileController.as_view("updateProfile"))
...
#views
controller.add_url_rule("/delete-profile/<int:id>", view_func=deleteProfileController.as_view("deleteProfile"))
...
#views
controller.add_url_rule("/user", view_func=userController.as_view("user"))
...
#views
controller.add_url_rule("/update-user", view_func=updateUserController.as_view("updateUser"))
...
#views
controller.add_url_rule("/update-ustatus/<int:id>", view_func=updateUserStatusController.as_view("updateUserStatus"))
...
#views
controller.add_url_rule("/search-user", view_func=searchUserController.as_view("searchUser"))
...
controller.add_url_rule('/media/<path:filename>', view_func=mediaController.as_view('media'))
...
#views
controller.add_url_rule("/buy", view_func=buyController.as_view("buy"))
...
#views
controller.add_url_rule("/search-location", view_func=searchListingLocationController.as_view("searchListingLocation"))
...
#views
controller.add_url_rule("/search-type", view_func=searchListingTypeController.as_view("searchListingType"))
...
#views
controller.add_url_rule("/search-price", view_func=searchListingPriceController.as_view("searchListingPrice"))
...
#views
controller.add_url_rule("/search-bedrooms", view_func=searchListingBedroomController.as_view("searchListingBedrooms"))
...
#views
controller.add_url_rule("/sell", view_func=sellController.as_view("sell"))
...
#views
controller.add_url_rule("/create-listing", view_func=createListingController.as_view("createListing"))
...
#views
controller.add_url_rule("/update-listing/<int:id>", view_func=updateListingController.as_view("updateListing"))
...
#views
controller.add_url_rule("/update-lstatus/<int:id>", view_func=updateListingStatusController.as_view("updateListingStatus"))
...
#views
controller.add_url_rule("/delete-listing/<int:id>", view_func=deleteListingController.as_view("deleteListing"))
...
#views
controller.add_url_rule("/listing/<string:title>-<int:listing_id>", view_func=viewListingController.as_view("viewListing"))
...
#views
controller.add_url_rule("/shortlist-listing/<int:id>", view_func=shortlistListingController.as_view("shortlistListing"))
...
#views
controller.add_url_rule("/my-activities", view_func=viewShortlistListingController.as_view("viewShortlistListing"))
...
#views
controller.add_url_rule("/find-agent", view_func=findAgentController.as_view("findAgent"))
...
#views
controller.add_url_rule("/find-agent/<string:first_name>-<string:last_name>-<int:agent_id>", view_func=viewAgentController.as_view("viewAgent"))
...
#views
controller.add_url_rule("/create-rating/<int:agent_id>", view_func=createRatingController.as_view("createRating"))
...
#views
controller.add_url_rule("/create-comment/<int:agent_id>", view_func=createCommentController.as_view("createComment"))
